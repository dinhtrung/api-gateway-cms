...
export class DomainComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.domainService
      ...
      .subscribe(
        (res: HttpResponse<IDomain[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IDomain): string {
  ...
  registerChangeInDomains(): void {
    this.eventSubscriber = this.eventManager.subscribe('domainListModification', () => this.loadPage());
  }
